...
-- detail page once they've researched a company, then used as an optional scoring
-- bonus (see lib/leads/scoring.ts MIN_ANNUAL_REVENUE_FOR_BONUS). Null/unknown is the
-- default and never penalizes a lead's score.
